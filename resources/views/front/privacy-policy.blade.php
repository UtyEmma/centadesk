<x-guest-layout>
    ...
    <div class="section section-padding pt-0">
        <div class="container">
            ...
            <p>Welcome to <strong>www.libraclass.com</strong>.</p>
            <p><strong>www.libraclass.com</strong> (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates <strong>libraclass.com</strong> (hereinafter referred to as <strong>&ldquo;Service&rdquo;</strong>).</p>
            <p>Our Privacy Policy governs your visit to <strong>libraclass.com</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <p><strong>SERVICE</strong> means the libraclass.com website operated by www.libraclass.com.</p>
            ...
            <li><strong>Students</strong> - These users are able to purchase courses and attend classes online. They also have the privilege of owning a unique referral link where they can refer users to purchase courses from libraclass.com.</li>
            </ul>
            ...
            <p>www.libraclass.com uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us by email: <strong>support@libraclass.com</strong>.</p>
        </div>
    </div>
</x-guest-layout>
