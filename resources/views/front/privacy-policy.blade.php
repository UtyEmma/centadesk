<x-guest-layout>
    <x-page-title title="Privacy Policy - {{env("APP_NAME")}}" />
    ...
    <div class="section section-padding pt-0">
        <div class="container">
            ...
            <p>Welcome to <strong>{{env("MAIN_APP_DOMAIN")}}</strong>.</p>
            <p><strong>{{env("MAIN_APP_DOMAIN")}}</strong> (&ldquo;us&rdquo;, &ldquo;we&rdquo;, or &ldquo;our&rdquo;) operates <strong>{{env("MAIN_APP_DOMAIN")}}</strong> (hereinafter referred to as <strong>&ldquo;Service&rdquo;</strong>).</p>
            <p>Our Privacy Policy governs your visit to <strong>{{env("MAIN_APP_DOMAIN")}}</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
            ...
            <p><strong>SERVICE</strong> means the {{env("MAIN_APP_DOMAIN")}} website operated by {{env("MAIN_APP_DOMAIN")}}.</p>
            ...
            <p><strong>THE USER</strong> is the individual using our Service. The User corresponds to the Data Subject, who is the subject of Personal Data. Our users are grouped into two(2) categories:</p>
            <ul>
            <li><strong>Mentors</strong> - These users are able to create and upload online courses as well as admit students into various batches for tutelage.</li>
            <li><strong>Students</strong> - These users are able to purchase courses and attend classes online. They also have the privilege of owning a unique referral link where they can refer users to purchase courses from {{env("MAIN_APP_DOMAIN")}}.</li>
            </ul>
            ...
            <li>Phone number</li>
            <li>Address, Country, State, Province, ZIP/Postal code,</li>
            ...
            <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, information on compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
            <p>5. <strong>Use of Data</strong></p>
            <p>{{env("MAIN_APP_DOMAIN")}} uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>{{env("MAIN_APP_DOMAIN")}} will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
            ...
            <p>10. <strong>Service Providers</strong></p>
            ...
            <p>13. <strong>Links to Other Sites</strong></p>
            ...
            <p>14. <strong>Changes to This Privacy Policy</strong></p>
            ...
            <p>15. <strong>Contact Us</strong></p>
            <p>If you have any questions about this Privacy Policy, please contact us by email: <strong>support@{{env("MAIN_APP_DOMAIN")}}</strong>.</p>
        </div>
    </div>
</x-guest-layout>
