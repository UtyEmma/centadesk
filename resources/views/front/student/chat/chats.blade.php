<x-student-layout>
    ...
    <div class="container py-5 px-4">
        <div class="row radius my-5 overflow-hidden border p-5">
            <!-- Users box-->
            <div class="col-5">
                <div class="border h-100 py-0 radius">
                    <div class="bg-light px-4 py-2 radius-top">
            ...
            <!-- Chat Box-->
            <div class="col-7 px-0 border radius">
            <div class="border-b">
                <a class="list-group-item list-group-item-action text-white border-0 bg-light radius-top">
            ...
            <div class="px-4 py-5 chat-box bg-white">
                ...
                <!-- Reciever Message-->
                <div class="media w-50 ms-auto mb-3" style="margin-right: ">
                <div class="media-body">
                    <div class="bg-primary rounded py-2 px-3 mb-2">
                    <p class="text-small mb-0 text-white">Apollo University, Delhi, India Test</p>
                    </div>
            ...
            <!-- Typing area -->
            <form action="#" class="bg-light radius-b">
