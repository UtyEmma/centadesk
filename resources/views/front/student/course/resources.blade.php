                    ...
                    <div class="border border-primary p-2 radius">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="w-auto d-flex py-1">
                                ...
                                <a href="{{$resource->link}}" title="{{$resource->title}}" type="button" class="btn btn-secondary btn-hover-primary h-auto btn-custom d-flex align-items-center justify-content-center py-1 px-2" >
