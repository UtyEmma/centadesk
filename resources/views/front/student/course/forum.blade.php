<x-enrolled-course :course="$course" :batch="$batch" :messages="$forum" :mentor="$mentor" :user="$user" :enrollment="$enrollment">
    <!-- Question & Answer End -->
    <div class="question-answer border-0">
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                ...
                <div class="answer-message-wrapper border-0 p-0" >
                    ...
                    <div class="border-0 forum-container" id="message-container">
                        @if (count($forum) > 0)
                            ...
                            <div class="message-form">
                                ...
                                <div class="message-input">
                                    ...
                                    <div class="single-form">
                                        <textarea name="message" class="form-control" placeholder="Your question details"></textarea>
                                    </div>
