<x-guest-layout>
    ...
    <div class="section section-padding pt-0">
        <div class="container">
            ...
            <p>While we have made every attempt to ensure that the information contained in this site has been obtained from reliable sources, www.libraclass.com is not responsible for any errors or omissions or for the results obtained from the use of this information. All information in this site is provided &ldquo;as is&rdquo;, with no guarantee of completeness, accuracy, timeliness or of the results obtained from the use of this information, and without warranty of any kind, express or implied, including, but not limited to warranties of performance, merchantability, and fitness for a particular purpose.</p>
            <p>In no event will www.libraclass.com, its related partnerships or corporations, or the partners, agents or employees thereof be liable to you or anyone else for any decision made or action taken in reliance on the information in this Site or for any consequential, special or similar damages, even if advised of the possibility of such damages.</p>
            <p><strong>GUEST CONTRIBUTORS DISCLAIMER</strong></p>
            <p>This Site may include content from guest contributors known as "<strong>mentors"</strong> and any views or opinions expressed in such posts are personal and do not represent those of www.libraclass.com or any of its staff or affiliates unless explicitly stated.</p>
            <p><strong>LOGOS AND TRADEMARKS DISCLAIMER</strong></p>
            <p>All logos and trademarks of third parties referenced on libraclass.com are the trademarks and logos of their respective owners. Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement or sponsorship of www.libraclass.com by such owners.</p>
            <p><strong>CONTACT US</strong></p>
            <p>Should you have any feedback, comments, requests for technical support or other inquiries, please contact us by email: <strong>suppport@libraclass.com</strong>.</p>
        </div>
    </div>
</x-guest-layout>
