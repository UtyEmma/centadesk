            ...
            <div class="admin-top-bar flex-wrap">
                ...
                <div class="top-bar-filter-right">
                    ...
                    <div class="filter-btn">
                        <a href="#" class="btn btn-primary btn-hover-dark">Export to CSV</a>
                    </div>
                </div>
            </div>
            <!-- Admin Top Bar End -->
            ...
            <div class="courses-rating-wrapper">
                ...
                <div class="single-courses-rating">
                    ...
                    <div class="courses">
                        ...
                        <div class="courses-content">
                            <h4 class="title"><a href="#">Build An eCommerce Site With WooCommerce and WooLentor.</a></h4>
                ...
                <div class="single-courses-rating">
                    ...
                    <div class="courses">
                        ...
                        <div class="courses-content">
                            <h4 class="title"><a href="#">Build An WholeSale WooCommerce Store using Whols Plugin</a></h4>
                            <div class="average-rating">
                                <span class="label">Course Rating:</span>
                                <span class="count">
                                        4.5
