        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
          <center>
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              <tr>
                <td class="header-lg">
                  Your Enrollment was completed successfully
                </td>
              </tr>
              <tr>
                <td class="free-text">
                  You have successfully enrolled for {{$batch->title}} of the {{$course->name}}. Please check out the details of your enrollment below.
                </td>
              </tr>
              <tr>
                <td class="button">
