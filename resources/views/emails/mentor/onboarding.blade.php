    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Your Mentorship Signup request has been received
            </td>
          </tr>
          <tr>
            <td class="free-text">
              We are reviewing your request and you will be able to start creating courses on Libraclass after your request has been approved.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="{{$data['dashboard']}}"
              style="background-color:#309255;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Proceed to my Dashboard</a></div>
            </td>
          </tr>
        </table>
      </center>
