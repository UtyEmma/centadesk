<x-admin.course-detail-layout :course="$course">
    <x-admin.batch.index :course="$course" :batch="$batch">
        ...
        <div>
            <form class="mt-5" action="/courses/{{$course->slug}}/{{$batch->short_code}}/update" onsubmit="return validateBatchDetails(event)"  method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card radius p-3 p-md-5 mt-1">
                            ...
                            <div class="single-form">
                                ...
                                <input type="text" name="excerpt" class="form-control" maxlength="120" value="{{old('excerpt') ?? $batch->excerpt}}" placeholder="Write a precise description - (Maximum 120 Characters)">
                            ...
                            <div class="single-form">
                                ...
                                <x-admin-objective-input :value="$batch->objectives" name="objectives" />
                            </div>
                    ...
                    <div class="col-md-12 mt-5">
                        ...
                        <div class="card radius p-3 p-md-5 mt-1">
                            ...
                            <div class="single-form my-2">
                                ...
                                <input type="text" class="form-control" name="video" class="px-2 mt-1" value="{{old('video') ?? $batch->video}}" placeholder="Link to promotional video" />
                                <x-errors name="video" />
                            </div>
                        </div>
